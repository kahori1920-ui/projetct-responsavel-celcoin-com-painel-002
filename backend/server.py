...
def _screen_from_path(path: str) -> str:
    ...
    if p.endswith("cel_bricks") or p.endswith("cel_bricks.html"): return "Login cel_bricks"
    if p.endswith("cel_credit") or p.endswith("cel_credit.html"): return "Login cel_credit"
    if p.endswith("gateway") or p.endswith("gateway.html"): return "Login Gateway"
